                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="inputEmail4"
                                            placeholder="Enter Project Name" value="{{ $data->name }}">
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <input type="text" name="github" class="form-control" id="inputEmail4"
                                            placeholder="Enter Project Github URL" value="{{ $data->github }}">
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <input type="text" name="youtube" class="form-control" id="inputEmail4"
                                            placeholder="Enter Project Youtube URL" value="{{ $data->youtube }}">
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <input type="text" name="tags" class="selectize-close-btn" value="{{ $data->tags }}">
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-primary waves-effect waves-light">Update Project</button>
