                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <a href="{{ route('social-media-create') }}" class="btn btn-blue waves-effect waves-light">Add
                                    Social Media</a>
                            </ol>
                        </div>
                        <h4 class="page-title"> All Social Media</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    @foreach ($datas as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('social-media-delete', $item->id) }}"
