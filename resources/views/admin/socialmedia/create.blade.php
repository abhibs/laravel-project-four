                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('social-media-store') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <input type="text" name="url" class="form-control" id="inputEmail4"
                                            placeholder="Enter Social Media URL" autocomplete="off">
                                        @error('url')
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <input type="text" name="icon" class="form-control" id="inputEmail4"
                                            placeholder="Enter Social Media Icon" autocomplete="off">
                                        @error('icon')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Add Social Media</button>
