                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('review-store') }}"
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Add Review</button>
